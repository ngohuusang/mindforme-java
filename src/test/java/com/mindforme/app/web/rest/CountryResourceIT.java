...
import com.mindforme.app.domain.Country;
import com.mindforme.app.domain.enumeration.Status;
import com.mindforme.app.repository.CountryRepository;
import com.mindforme.app.repository.search.CountrySearchRepository;
import com.mindforme.app.service.CountryService;
import com.mindforme.app.service.dto.CountryDTO;
import com.mindforme.app.service.mapper.CountryMapper;
...
public class CountryResourceIT {
     ...
     *
     * @see com.mindforme.app.repository.search.CountrySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).code(DEFAULT_CODE).status(DEFAULT_STATUS);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).code(UPDATED_CODE).status(UPDATED_STATUS);
        return country;
    }
    ...
    public void createCountry() throws Exception {
        ...
        restCountryMockMvc
            .perform(post("/api/countries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(countryDTO)))
    ...
    public void updateCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).code(UPDATED_CODE).status(UPDATED_STATUS);
        CountryDTO countryDTO = countryMapper.toDto(updatedCountry);

        restCountryMockMvc
            .perform(put("/api/countries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(countryDTO)))
            .andExpect(status().isOk());
