package com.mindforme.app.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.mindforme.app.MindformeApp;
import com.mindforme.app.repository.timezone.DateTimeWrapper;
import com.mindforme.app.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM m4m_date_time_wrapper where id=%d", fieldName, id);
    }
