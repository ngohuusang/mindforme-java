...
export const Payment = (props: IPaymentProps) => {
  ...
  const { paymentList, match, loading, totalItems } = props;
  return (
    <div>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('lastFour')}>
                  Last Four <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('expireDate')}>
                  Expire Date <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('tripeCustomerId')}>
                  Tripe Customer Id <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {paymentList.map((payment, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{payment.tripeCustomerId}</td>
                  <td>{payment.cardType}</td>
                  <td>{payment.familyName ? <Link to={`family/${payment.familyId}`}>{payment.familyName}</Link> : ''}</td>
