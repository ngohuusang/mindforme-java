...
export const EmergencyContactDeleteDialog = (props: IEmergencyContactDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mindformeApp.emergencyContact.delete.question">Are you sure you want to delete this EmergencyContact?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="m-4-m-confirm-delete-emergencyContact" color="danger" onClick={confirmDelete}>
