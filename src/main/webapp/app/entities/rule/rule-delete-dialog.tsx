...
export const RuleDeleteDialog = (props: IRuleDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mindformeApp.rule.delete.question">Are you sure you want to delete this Rule?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="m-4-m-confirm-delete-rule" color="danger" onClick={confirmDelete}>
