  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mindformeApp.message.home.createOrEditLabel">Create or edit a Message</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : messageEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="message-sender" type="select" className="form-control" name="senderId">
                  <option value="" key="0" />
                  {users
              ...
              <AvGroup>
                ...
                <AvInput id="message-receiver" type="select" className="form-control" name="receiverId">
                  <option value="" key="0" />
                  {users
                    ? users.map(otherEntity => (
                        <option value={otherEntity.id} key={otherEntity.id}>
