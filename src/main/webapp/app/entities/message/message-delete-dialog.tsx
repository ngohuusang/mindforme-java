...
export const MessageDeleteDialog = (props: IMessageDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mindformeApp.message.delete.question">Are you sure you want to delete this Message?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="m-4-m-confirm-delete-message" color="danger" onClick={confirmDelete}>
