            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('line')}>
                  Line <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('suburb')}>
                  Suburb <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {addressList.map((address, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{address.stateName ? <Link to={`state/${address.stateId}`}>{address.stateName}</Link> : ''}</td>
                  <td>{address.countryName ? <Link to={`country/${address.countryId}`}>{address.countryName}</Link> : ''}</td>
                  <td>{address.cityName ? <Link to={`city/${address.cityId}`}>{address.cityName}</Link> : ''}</td>
