...
/**
 * A DTO for the {@link com.mindforme.app.domain.PetTypeData} entity.
 */
public class PetTypeDataDTO implements Serializable {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PetTypeDataDTO)) {
            return false;
        }

        return id != null && id.equals(((PetTypeDataDTO) o).id);
    }
